...
/decl/hierarchy/outfit/job/site90/crew/security/ltofficerlcz
	...
	r_pocket = /obj/item/melee/telebaton
	back = /obj/item/storage/backpack/satchel/leather/black
	backpack_contents = list(/obj/item/handcuffs = 1, /obj/item/clothing/glasses/sunglasses/sechud/goggles = 1)
	belt = /obj/item/storage/belt/holster/security/fullmk9
...
/decl/hierarchy/outfit/job/site90/crew/command/event/mtfbasic/non_specific
	name = OUTFIT_JOB_NAME("MTF Agent")
...
/decl/hierarchy/outfit/job/site90/crew/command/event/mtfbasic
	...
	uniform = /obj/item/clothing/under/scp/ntf
	suit = /obj/item/clothing/suit/armor/mtftactical/ntf
	head = /obj/item/clothing/head/helmet/mtftactical/ntf
	mask = /obj/item/clothing/mask/gas/scp/ntf
	gloves = /obj/item/clothing/gloves/thick/swat
	shoes = /obj/item/clothing/shoes/swat
	id_types = list(/obj/item/card/id/mtf)
	l_ear = /obj/item/device/radio/headset/ert
